    ...
    children: [
      {
        ...
        component: Menu,
        props: { id: 'framework' },
        redirect: { name: 'FrameworkSystestAppRandomTest' },
        children: [
          {
            path: '/framework/systest/apprandomtest',
            name: 'FrameworkSystestAppRandomTest',
            component: () => import('@/views/framework/systest/AppRandomTest')
          },
          {
            path: '/framework/systest/sysrandomtest',
            name: 'FrameworkSystestSysRandomTest',
            component: () => import('@/views/framework/systest/SysRandomTest')
          },
          {
            path: '/framework/systest/insomniatest',
            name: 'FrameworkSystestInsomniaTest',
            component: () => import('@/views/framework/systest/InsomniaTest')
          },
          {
            path: '/framework/systest/testhistory',
            name: 'FrameworkTestHistory',
            component: () => import('@/views/framework/systest/TestHistory')
          },
          {
